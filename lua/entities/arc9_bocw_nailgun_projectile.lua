...
if CLIENT then
    killicon.Add("arc9_bocw_nailgun_projectile", "entities/obit_arc9_nailgun.png", Color(255, 255, 255, 255))
end
...
if SERVER then
    ...
    function ENT:Initialize()
        self:SetModel("models/weapons/arc9/entities/bocw_nailgun_projectile.mdl")
